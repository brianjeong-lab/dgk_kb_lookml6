view: keyword_bank_result {
  sql_table_name: `master_200723.keyword_bank_result`
    ;;
  drill_fields: [id]
...
view: keyword_bank_result__d2_c {
  dimension: label {
    type: string
    sql: ${TABLE}.label ;;
  }
...
view: keyword_bank_result__response {
  dimension: err_msg {
    type: string
    sql: ${TABLE}.err_msg ;;
  }
